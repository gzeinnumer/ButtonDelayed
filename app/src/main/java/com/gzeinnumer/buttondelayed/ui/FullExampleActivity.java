...
public class FullExampleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_example);
        initView();
    }
        ...
        switch (id) {
            ...
            case R.id.layEndCompleteDrawableIcon: {
                if (!requestPermissions(this, Manifest.permission.READ_EXTERNAL_STORAGE,
                    ...
                    Matisse.from(FullExampleActivity.this)
